...
final class AppShellModelWordCardTests: XCTestCase {
    ...
    func testSelectPopupWordShowsEmptyCardWithoutFailingTranslation() async {
    ...
    func testSelectPopupWordShowsFailureCardWithoutFailingTranslation() async {
    ...
    private func makeServices(
        ...
        LinguistServices(
            ...
            historyStore: WordCardTestTranslationHistoryStore(),
